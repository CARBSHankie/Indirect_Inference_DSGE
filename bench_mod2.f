 ...
 102                        continue
      close(50)
10110 format(25f13.8)
10112 format(7f12.8)
      DO 10100 I = 1,NDOG                                               
      WRITE(13,90000)  ( E(I,J),J=1,147 )                               
10100 CONTINUE                                                          
      DO 10200 I = 1,LEXOG                                              
      WRITE(13,90000)  ( X(I,J),J=1,147 )                               
10200 CONTINUE                                                          
...
10000 CONTINUE                                                          
 ...
 3013    read(35,*)(e(i,j),j=1,nlag)
      ...
      KVAR=KK(IC)+IV
      read(99,7001) IC,IVV                                              
      read(99,7501) ( ER(KVAR,IY),IY=1,199 )
 8010 continue
      DO 8020 I=1,LEXOG
 8020 read(98,7501) (X(I,J), J=1,199)
 7001 FORMAT(2I2)                                                    
 7501 FORMAT(4F18.12)                                                
...
20000 CONTINUE                                                          
  ...
  110 V(KIC+IE)=E(KIC+IE,I)                                             
     ...
     3,NXGP,NCG,IDYN1,IRANDX,IB,IRHO                                         
      ...
      EQUIVALENCE ( XEQUIV(1),X(1,1) )                                  
      DO 10000 I = 1,NDOG                                               
      WRITE(12,90000)  ( E(I,J),J=1,147 )                               
10000 CONTINUE                                                          
      DO 12000 I = 1,LEXOG                                              
      WRITE(12,90000)  ( X(I,J),J=1,147 )                               
12000 CONTINUE                                                          
90000 FORMAT(4F18.12)                                                    
      TITLE1='     SIMUL'                                               
      TITLE2='ATION     '                                               
